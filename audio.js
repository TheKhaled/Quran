...
var listQ = {
  ...
  eslam: "Eslam sobhy",
  hazaa: "Hazaa El Belushi",
  // mohamed:"mohamed elshary",
  // khled:"khaled Hisham",
  // akraem:" Mahmoud Akram ",
};
...
///  this is to handle the rang time
...
for (var g = 0; g < readers.length; g++) {
  readers[g].addEventListener(
    "click",
    (function (index) {
      return function (e) {
        figcaption.textContent = Object.values(listQ)[index];
        img.src = `pics/${Object.keys(listQ)[index]}.jpeg`;
        theaudio.src = `${index + 1}.mp3`;
      };
    })(g)
  );
